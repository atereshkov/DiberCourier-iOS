...
class AddressDTO {
    ...
    init(id: Int, name: String, postalCode: Int, country: String, city: String, region: String, address: String, phone: String) {
        self.id = id
        self.name = name
...
extension AddressDTO {
    ...
    class func with(data: [String: Any]) -> AddressDTO? {
        ...
        return AddressDTO(id: id, name: name, postalCode: postalCode, country: country, city: city, region: region, address: address, phone: phone)
    }
}
